...
function reducer(state,action){
  ...
  switch(action.type){ //type is set in dispatch fuction
...
function Example1(){
  const [state,dispatch] = useReducer(reducer,{count:0}) // we can also use reducer,0 then use count in place state
